...
export const decodeEventStrict = (
  input: unknown
): Effect.Effect<AllEventsType, ParseResult.ParseError> =>
...
export const decodeEventEitherStrict = (
  input: unknown
): Either.Either<AllEventsType, ParseResult.ParseError> =>
